...
- **⚠️ Confirm the free Open tier actually allows a System/backend-services app.** This is the one real unknown in the design. If the free tier only allows Patient/Provider _launch_ (interactive login), the auth flow needs adjusting — flag it.
